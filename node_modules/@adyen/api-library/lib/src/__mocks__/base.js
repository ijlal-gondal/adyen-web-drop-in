...
const createClient = (apiKey = process.env.ADYEN_API_KEY) => {
    ...
    config.legalEntityManagementEndpoint = client_1.default.LEGAL_ENTITY_MANAGEMENT_API_ENDPOINT_TEST;
    config.transfersEndpoint = client_1.default.TRANSFERS_API_VERSION_TEST;
